...
/**
 * Utility class designed to generate content fields and add them to 
 * Documents that are being added to the index.
 *
 * This class is responsible for parsing the required document and adding
...
public class ContentGenerator {
	 ...
	 * and adds the content of the file to a field in the Document with
	 * the title "Content".
	 * 
	 * Precondition (checked in IndexHandler): fileType must be either
	 * pdf, txt, html or docx.
	 * 
